...
public class Server2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Get public key
			byte[] publickeyServerBytes = Files.readAllBytes(new File("D:\\publickey_eBay_server.txt").toPath());
			...
			// Get private key
			byte[] privatekeyBytes = Files.readAllBytes(new File("D:\\privatekey_eBay_server.txt").toPath());
			...
			while (true) {
				...
				c = Cipher.getInstance("AES");
				productlist = readCSV("C:\\Users\\sampa\\eclipse-workspace2\\NetSecProj\\src\\productlist_eBay.csv");
				...
				if (product_ID.equals("1")) {
					product = readFile("C:\\Users\\sampa\\eclipse-workspace2\\NetSecProj\\src\\product1_eBay.txt");

				}
				if (product_ID.equals("2")) {
					product = readFile("C:\\Users\\sampa\\eclipse-workspace2\\NetSecProj\\src\\product2_eBay.txt");

				}
				if (product_ID.equals("3")) {
					product = readFile("C:\\Users\\sampa\\eclipse-workspace2\\NetSecProj\\src\\product3_eBay.txt");

				}
				if (product_ID.equals("4")) {
					product = readFile("C:\\Users\\sampa\\eclipse-workspace2\\NetSecProj\\src\\product4_eBay.txt");
